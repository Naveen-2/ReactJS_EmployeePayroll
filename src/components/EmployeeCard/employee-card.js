...
const EmployeeCard = () => { 
    ...
    useEffect(() => {
        const getAllEmployeeData = async () => {
            ...
            if(allEmployees) setEmployeesData(allEmployees);
        };
        ...
        <>  
            {
                employeesData.data && employeesData.data.map((element, index) =>(
                    <tr key={index}>
                        <td className="empID">{element.id}</td>
                        <td><img className="profile" src={(element.profileUrl === '../../assets/profile-images/Ellipse -1.png') ? ProfilePic1:
                                                           (element.profileUrl === '../../assets/profile-images/Ellipse -2.png') ? ProfilePic2:
                                                           (element.profileUrl === '../../assets/profile-images/Ellipse -3.png') ? ProfilePic3:
                                                           (element.profileUrl === '../../assets/profile-images/Ellipse -4.png') ? ProfilePic4:
                                                           ""} alt=""/></td>
                        ...
                        <td>
                            ...
                            <img src={delete_btn} alt="delete" id={element.id} onClick={() => {removeEmployee(element.id)}}/>
